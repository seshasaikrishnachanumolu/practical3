pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://100.24.29.88:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/seshasaikrishnachanumolu/practical3.git', branch: 'master'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://100.24.29.88:9090/springapp1"
            echo "✅ Frontend deployed: http://100.24.29.88:9090/frontapp1"
        }
        failure {
